...
{
    /// Minimo = 75 de abertura
    /// Maximo = 125 de abertura
...
//    printf("Menor ponto: %f\n", 150 + 200 -          Abertura/2 - Amplitude);
//    printf("Maior ponto: %f\n", 150 + 200 + 150 +    Abertura/2 + Amplitude);
