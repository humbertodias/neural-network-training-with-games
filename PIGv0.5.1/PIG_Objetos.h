...
void DesenharSprite(int id_sprite, int X, int Y, int Largura, int Altura, float Angulo, int Alinhar=0)
{
    if(PIG_ExistenciaObjeto[id_sprite] == 1)
    {
        CGerenciadorObjetos::DesenhaSprite(id_sprite,X,Y,Largura,Altura,Angulo,Alinhar);
    }
}
