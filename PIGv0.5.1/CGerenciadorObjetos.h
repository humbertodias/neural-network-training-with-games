...
public:
    ...
    inline static void DesenhaSprite(int id_objeto, int X, int Y, int Largura, int Altura, float Angulo, int Alinhar=0){
        objetos[id_objeto]->DesenhaSprite(X,Y,Largura,Altura,Angulo,Alinhar);
    }
